  ...
  return (
    <html lang="en" className="dark">
      <head>
        ...
        />
        <style dangerouslySetInnerHTML={{__html: ".material-symbols-outlined { font-variation-settings: 'FILL' 0, 'wght' 400, 'GRAD' 0, 'opsz' 24; } .editorial-grid { display: grid; grid-template-columns: repeat(12, 1fr); gap: 2rem; }"}} />
      </head>
